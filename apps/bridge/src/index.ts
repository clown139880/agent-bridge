...
const client = new BridgeClient({
  ...
  claudePermissionAllow: config.claudePermissionAllow,
  claudePermissionDeny: config.claudePermissionDeny,
  claudeAdditionalDirectories: config.claudeAdditionalDirectories,
  ...
  archiveOutboxPath: config.archiveOutboxPath,
