/**
 * PushableAsyncIterable - a single-consumer async iterable that external code can
 * push values into. Used as the stream-json stdin channel to Claude Code.
 * Ported verbatim from hapi (cli/src/utils/PushableAsyncIterable.ts).
 */
